...
export default function PrescriptionsScreen() {
  const prescriptions = [
    { dr: "Dr. Rohan Joshi", spec: "Cardiologist", date: "Oct 12", meds: ["Lisinopril 10mg", "Vitamin D3"], primary: false },
    { dr: "Dr. Sarah Deshmukh", spec: "GP", date: "Current", meds: ["Amoxicillin 500mg"], primary: true },
  ];
